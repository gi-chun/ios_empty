...
+ (BOOL)openKakaoAppLinkWithMessage:(NSString *)message
    ...
    NSString *appDataString = [jsonWriter stringWithFragment:[NSDictionary dictionaryWithObject:metaInfoArray forKey:@"metainfo"]];
...
+ (BOOL)openStoryLinkWithPost:(NSString *)post
	...
	if (urlInfoDict.count > 0) {
		[parameters setObject:[jsonWriter stringWithFragment:urlInfoDict] forKey:@"urlinfo"];
	}
