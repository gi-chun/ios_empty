...
NSString *const kOPGPUImageSaturationFragmentShaderString = OPSHADER_STRING
(
...
@implementation OPGPUImageSaturationFilter
...
- (id)init;
{
    if (!(self = [super initWithFragmentShaderFromString:kOPGPUImageSaturationFragmentShaderString]))
    {
		return nil;
    }
