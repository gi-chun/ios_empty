...
NSString *const kOPGPUImageColorMatrixFragmentShaderString = OPSHADER_STRING
(
...
@implementation OPGPUImageColorMatrixFilter
...
- (id)init;
{
    if (!(self = [super initWithFragmentShaderFromString:kOPGPUImageColorMatrixFragmentShaderString]))
    {
        return nil;
    }
    ...
    self.intensity = 1.f;
    self.colorMatrix = (OPGPUMatrix4x4){
        {1.f, 0.f, 0.f, 0.f},
        {0.f, 1.f, 0.f, 0.f},
        {0.f, 0.f, 1.f, 0.f},
        {0.f, 0.f, 0.f, 1.f}
...
- (void)setColorMatrix:(OPGPUMatrix4x4)newColorMatrix;
{
