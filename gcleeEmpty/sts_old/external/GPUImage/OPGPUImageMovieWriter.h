...
extern NSString *const kOPGPUImageColorSwizzlingFragmentShaderString;

@protocol OPGPUImageMovieWriterDelegate <NSObject>
...
@interface OPGPUImageMovieWriter : NSObject <OPGPUImageInput>
{
...
@property(nonatomic, assign) id<OPGPUImageMovieWriterDelegate> delegate;
