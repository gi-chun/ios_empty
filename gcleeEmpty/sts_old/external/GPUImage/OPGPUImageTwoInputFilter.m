...
NSString *const kOPGPUImageTwoInputTextureVertexShaderString = OPSHADER_STRING
(
...
@implementation OPGPUImageTwoInputFilter
...
{
    if (!(self = [self initWithVertexShaderFromString:kOPGPUImageTwoInputTextureVertexShaderString fragmentShaderFromString:fragmentShaderString]))
    {
		return nil;
    }
...
- (id)initWithVertexShaderFromString:(NSString *)vertexShaderString fragmentShaderFromString:(NSString *)fragmentShaderString;
{
    ...
    inputRotation2 = kOPGPUImageNoRotation;
...
- (CGSize)rotatedSize:(CGSize)sizeToRotate forIndex:(NSInteger)textureIndex;
{
    ...
    OPGPUImageRotationMode rotationToCheck;
    if (textureIndex == 0)
    {
    ...
    if (OPGPUImageRotationSwapsWidthAndHeight(rotationToCheck))
    {
