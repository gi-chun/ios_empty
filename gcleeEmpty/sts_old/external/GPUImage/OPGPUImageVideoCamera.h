...
extern const GLfloat kOPColorConversion601[];
extern const GLfloat kOPColorConversion709[];
extern NSString *const kOPGPUImageYUVVideoRangeConversionForRGFragmentShaderString;
extern NSString *const kOPGPUImageYUVVideoRangeConversionForLAFragmentShaderString;


//Delegate Protocal for Face Detection.
@protocol OPGPUImageVideoCameraDelegate <NSObject>
...
*/
@interface OPGPUImageVideoCamera : OPGPUImageOutput <AVCaptureVideoDataOutputSampleBufferDelegate, AVCaptureAudioDataOutputSampleBufferDelegate>
{
    ...
    BOOL capturePaused;
    OPGPUImageRotationMode outputRotation;
    dispatch_semaphore_t frameRenderingSemaphore;
        
    BOOL captureAsYUV;
    GLuint luminanceTexture, chrominanceTexture;

    __unsafe_unretained id<OPGPUImageVideoCameraDelegate> _delegate;
}
...
@property(nonatomic, assign) id<OPGPUImageVideoCameraDelegate> delegate;
