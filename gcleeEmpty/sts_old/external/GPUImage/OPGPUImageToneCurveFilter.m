...
#if TARGET_IPHONE_SIMULATOR || TARGET_OS_IPHONE
NSString *const kOPGPUImageToneCurveFragmentShaderString = OPSHADER_STRING
(
...
@interface OPGPUImageToneCurveFilter()
{
...
@implementation OPGPUImageToneCurveFilter
...
- (id)init;
{
    if (!(self = [super initWithFragmentShaderFromString:kOPGPUImageToneCurveFragmentShaderString]))
    {
		return nil;
    }
