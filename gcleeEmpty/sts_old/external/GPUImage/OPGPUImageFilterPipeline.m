...
@interface OPGPUImageFilterPipeline ()
...
@implementation OPGPUImageFilterPipeline
...
- (BOOL)_parseConfiguration:(NSDictionary *)configuration {
    ...
    for (NSDictionary *filter in filters) {
        ...
        OPGPUImageFilter *genericFilter = [[theClass alloc] init];
...
- (void)_refreshFilters {
    ...
    OPGPUImageFilter *theFilter = nil;
...
- (UIImage *)currentFilteredFrame {
    return [(OPGPUImageFilter *)[_filters lastObject] imageFromCurrentlyProcessedOutput];
}

- (UIImage *)currentFilteredFrameWithOrientation:(UIImageOrientation)imageOrientation {
  return [(OPGPUImageFilter *)[_filters lastObject] imageFromCurrentlyProcessedOutputWithOrientation:imageOrientation];
}

- (CGImageRef)newCGImageFromCurrentFilteredFrame {
    return [(OPGPUImageFilter *)[_filters lastObject] newCGImageFromCurrentlyProcessedOutput];
}

- (CGImageRef)newCGImageFromCurrentFilteredFrameWithOrientation:(UIImageOrientation)imageOrientation {
    return [(OPGPUImageFilter *)[_filters lastObject] newCGImageFromCurrentlyProcessedOutputWithOrientation:imageOrientation];
}
