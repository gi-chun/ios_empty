...
typedef struct OPGPUTextureOptions {
    GLenum minFilter;
    GLenum magFilter;
    GLenum wrapS;
    GLenum wrapT;
 ...
 */
@interface OPGPUImageOutput : NSObject <OPGPUImageTextureDelegate>
{
    ...
    __unsafe_unretained id<OPGPUImageTextureDelegate> firstTextureDelegate;
...
@property(readwrite, nonatomic, retain) OPGPUImageMovieWriter *audioEncodingTarget;
@property(readwrite, nonatomic, unsafe_unretained) id<OPGPUImageInput> targetToIgnoreForUpdates;
@property(nonatomic, copy) void(^frameProcessingCompletionBlock)(OPGPUImageOutput*, CMTime);
@property(nonatomic) BOOL enabled;
@property(readwrite, nonatomic) OPGPUTextureOptions outputTextureOptions;

/// @name Managing targets
- (void)setInputTextureForTarget:(id<OPGPUImageInput>)target atIndex:(NSInteger)inputTextureIndex;
 ...
 */
- (void)addTarget:(id<OPGPUImageInput>)newTarget;
 ...
 */
- (void)removeTarget:(id<OPGPUImageInput>)targetToRemove;
